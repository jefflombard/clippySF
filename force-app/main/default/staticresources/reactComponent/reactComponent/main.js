 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(true){(function(){'use strict';var invariant=__webpack_require__(4);var React=__webpack_require__(1);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(12);var _assign=__webpack_require__(3);var emptyFunction=__webpack_require__(7);var checkPropTypes=__webpack_require__(8);var getActiveElement=__webpack_require__(13);var shallowEqual=__webpack_require__(14);var containsNode=__webpack_require__(15);var emptyObject=__webpack_require__(5);var hyphenateStyleName=__webpack_require__(18);var camelizeStyleName=__webpack_require__(20);// Relying on the `invariant()` implementation lets us
// have preserve the format and params in the www builds.
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _clippyjs2.default.load('Clippy', function (agent) {
            agent.show();
            _this.state = {
                agent: agent
            };
...
Queue.prototype._progressQueue = function _progressQueue() {
    ...
    // execute function
    var completeFunction = _jquery2.default.proxy(this.next, this);
    f(completeFunction);
};
...
var Animator = function Animator(el, path, data, sounds) {
    ...
    for (var i = 1; i < this._data.overlayCount; i++) {
        var inner = this$1._setupElement((0, _jquery2.default)('<div></div>'));
        curr.append(inner);
...
Animator.prototype._step = function _step() {
    ...
    this._loop = window.setTimeout(_jquery2.default.proxy(this._step, this), this._currentFrame.duration);
...
Balloon.prototype._setup = function _setup() {
    ...
    this._balloon = (0, _jquery2.default)('<div class="clippy-balloon"><div class="clippy-tip"></div><div class="clippy-content"></div></div> ').hide();
    this._content = this._balloon.find('.clippy-content');

    (0, _jquery2.default)(document.body).append(this._balloon);
};
...
Balloon.prototype._position = function _position(side) {
    ...
    o.top -= (0, _jquery2.default)(window).scrollTop();
    o.left -= (0, _jquery2.default)(window).scrollLeft();
...
Balloon.prototype._isOut = function _isOut() {
    ...
    var sT = (0, _jquery2.default)(document).scrollTop();
    var sL = (0, _jquery2.default)(document).scrollLeft();
...
Balloon.prototype.hide = function hide(fast) {
    ...
    this._hiding = window.setTimeout(_jquery2.default.proxy(this._finishHideBalloon, this), this.CLOSE_BALLOON_DELAY);
};
...
Balloon.prototype._sayWords = function _sayWords(text, hold, complete) {
    ...
    this._addWord = _jquery2.default.proxy(function () {
        if (!this._active) {
            return;
        }
        if (idx > words.length) {
            ...
            idx++;
            this._loop = window.setTimeout(_jquery2.default.proxy(this._addWord, this), time);
        }
    }, this);
...
var Agent = function Agent(path, data, sounds) {
    ...
    this._queue = new Queue(_jquery2.default.proxy(this._onQueueEmpty, this));

    this._el = (0, _jquery2.default)('<div class="clippy"></div>').hide();

    (0, _jquery2.default)(document.body).append(this._el);
...
Agent.prototype.moveTo = function moveTo(x, y, duration) {
    ...
    this._addToQueue(function (complete) {
        ...
        var callback = _jquery2.default.proxy(function (name, state) {
            ...
            if (state === Animator.States.WAITING) {
                this._el.animate({ top: y, left: x }, duration, _jquery2.default.proxy(function () {
...
Agent.prototype._playInternal = function _playInternal(animation, callback) {
    ...
    if (this._isIdleAnimation() && this._idleDfd && this._idleDfd.state() === 'pending') {
        this._idleDfd.done(_jquery2.default.proxy(function () {
...
Agent.prototype.play = function play(animation, timeout, cb) {
    ...
    this._addToQueue(function (complete) {
        ...
        if (timeout) {
            window.setTimeout(_jquery2.default.proxy(function () {
                if (completed) {
                    return;
                }
                // exit after timeout
...
Agent.prototype.show = function show(fast) {
    ...
    if (this._el.css('top') === 'auto' || !this._el.css('left') === 'auto') {
        var left = (0, _jquery2.default)(window).width() * 0.8;
        var top = ((0, _jquery2.default)(window).height() + (0, _jquery2.default)(document).scrollTop()) * 0.8;
...
Agent.prototype._onQueueEmpty = function _onQueueEmpty() {
    ...
    this._idleDfd = _jquery2.default.Deferred();

    this._animator.showAnimation(idleAnim, _jquery2.default.proxy(this._onIdleComplete, this));
};
...
Agent.prototype._setupEvents = function _setupEvents() {
    (0, _jquery2.default)(window).on('resize', _jquery2.default.proxy(this.reposition, this));

    this._el.on('mousedown', _jquery2.default.proxy(this._onMouseDown, this));

    this._el.on('dblclick', _jquery2.default.proxy(this._onDoubleClick, this));
};
...
Agent.prototype.reposition = function reposition() {
    ...
    var sL = (0, _jquery2.default)(window).scrollLeft();
...
Agent.prototype._startDrag = function _startDrag(e) {
    ...
    this._moveHandle = _jquery2.default.proxy(this._dragMove, this);
    this._upHandle = _jquery2.default.proxy(this._finishDrag, this);

    (0, _jquery2.default)(window).on('mousemove', this._moveHandle);
    (0, _jquery2.default)(window).on('mouseup', this._upHandle);

    this._dragUpdateLoop = window.setTimeout(_jquery2.default.proxy(this._updateLocation, this), 10);
};
...
Agent.prototype._finishDrag = function _finishDrag() {
    ...
    // remove handles
    (0, _jquery2.default)(window).off('mousemove', this._moveHandle);
    (0, _jquery2.default)(window).off('mouseup', this._upHandle);
    // resume animations
    this._balloon.show();
    this.reposition();
    this.resume();
...
Agent.prototype._addToQueue = function _addToQueue(func, scope) {
    if (scope) {
        func = _jquery2.default.proxy(func, scope);
    }
...
var load = function load(name, successCb, failCb, base_path) {
    ...
    _jquery2.default.when(mapDfd, agentDfd, soundsDfd).done(cb).fail(failCb);
};
...
load._loadMap = function _loadMap(path) {
    ...
    dfd = load._maps[path] = _jquery2.default.Deferred();
...
load._loadSounds = function _loadSounds(name, path) {
    ...
    // set dfd if not defined
    dfd = load._sounds[name] = _jquery2.default.Deferred();
...
load._getAgentDfd = function _getAgentDfd(name) {
    var dfd = load._data[name];
    if (!dfd) {
        dfd = load._data[name] = _jquery2.default.Deferred();
    }
    return dfd;
};
